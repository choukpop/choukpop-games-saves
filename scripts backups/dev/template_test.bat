...
set "BACKUP_TEST=C:\Users\ChouKpop\Desktop"
...
set "game_save[3]=file|C:\Users\ChouKpop\Desktop\config.json"
set "game_save[4]=folder|C:\Users\ChouKpop\Desktop\removed game"

:: ============================================================
:: Backup destinations (must match the same index)
:: ============================================================
set "github_copy_save[1]=%BACKUP_TEST%\backup"
set "github_copy_save[2]=%BACKUP_TEST%\backup"
set "github_copy_save[3]=%BACKUP_TEST%\backup"
set "github_copy_save[4]=%BACKUP_TEST%\backup"
