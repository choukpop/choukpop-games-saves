...
set "GAME_SAVE_PATH=C:\Users\ChouKpop\AppData\Local\Pal"
...
:: BACKUP folders
set "github_copy_save[1]=D:\Bibliotecas\Others\GitHub\choukpop-games-saves\Single Player Games\Survival\Palworld\Pal\Saved"
set "github_copy_save[2]=D:\Bibliotecas\Others\GitHub\choukpop-games-saves\Single Player Games\Survival\Palworld\Pal\Saved\Config"
