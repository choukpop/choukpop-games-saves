...
set "GAME_SAVE_PATH=C:\Users\ChouKpop\AppData\LocalLow\Frozen District"
...
:: ========================================
set "game_save[1]=folder|C:\Users\ChouKpop\AppData\LocalLow\Frozen District\House Flipper 2"

:: BACKUP folders
set "github_copy_save[1]=D:\Bibliotecas\Others\GitHub\choukpop-games-saves\Single Player Games\Simulation\House Flipper Series\House Flipper 2\Frozen District"
