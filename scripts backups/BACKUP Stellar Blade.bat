...
:: ============================================================
set "github_copy_save[1]=%GITHUB_BASE_PATH%\Single Player Games\Story\Stellar Blade\SB\Saved\SaveGames"
set "github_copy_save[2]=%GITHUB_BASE_PATH%\Single Player Games\Story\Stellar Blade\SB\Saved\Config"
