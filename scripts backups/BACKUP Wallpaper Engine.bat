...
:: ============================================================
set "GAME_SAVE_PATH=D:\SteamLibrary\steamapps\common\wallpaper_engine"
set "GITHUB_BASE_PATH=D:\Bibliotecas\Others\GitHub\choukpop-games-saves"
set "GITHUB_BACKUP_FOLDER=C:\Users\ChouKpop\Desktop"

:: ============================================================
:: Items: type|path (type: folder or file)
:: ============================================================
set "game_save[1]=folder|D:\SteamLibrary\steamapps\common\wallpaper_engine\projects\myprojects"
set "game_save[2]=file|D:\SteamLibrary\steamapps\common\wallpaper_engine\config.json"

:: ============================================================
:: Backup destinations (must match the same index)
:: ============================================================
set "github_copy_save[1]=C:\Users\ChouKpop\Desktop\Wallpaper Engine"
set "github_copy_save[2]=C:\Users\ChouKpop\Desktop\Wallpaper Engine"
